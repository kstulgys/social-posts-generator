...
export function TwitterIcon({ size = 20 }: IconProps) {
  return (
    <svg style={{ height: `${size}px`, width: `${size}px` }} viewBox="0 0 24 24" fill="currentColor">
...
export function BoltIcon({ size = 20 }: IconProps) {
  return (
    <svg style={{ height: `${size}px`, width: `${size}px` }} viewBox="0 0 24 24" fill="none" stroke="currentColor">
...
export function ChevronDownIcon({ size = 16 }: IconProps) {
  return (
    <svg style={{ height: `${size}px`, width: `${size}px` }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function CheckIcon({ size = 16 }: IconProps) {
  return (
    <svg style={{ height: `${size}px`, width: `${size}px` }} fill="currentColor" viewBox="0 0 20 20">
      <path
        fillRule="evenodd"
...
export function DiceIcon({ size = 20 }: IconProps) {
  return (
    <svg style={{ height: `${size}px`, width: `${size}px` }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path
        strokeLinecap="round"
